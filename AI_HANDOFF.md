...
- الحالة: مدموج ومنشور — آخر دمج `de6ee23` (2026-07-26) يضم إصلاح تشويه أصناف
  السطر المدمج، ورسالة شفافية الحفظ، وتنبيه «تحت التكلفة» المعلوماتي، واعتبار
  سعر الجملة الصفري «غير مسعّر». النسخة المنشورة **tobacco-115 / v386**
  (رُفع الكاش إلى v386 لا v382 لأن مولّد النشرات كان قد رفعه تلقائياً إلى v385).

...
- الحالة: مدموج ومنشور — 14 إنزالاً في 2026-07-25. آخر دمج `961e01d` يضم ثلاثة
  أعمال معتمدة من Codex: طباعة PWA داخل iframe، واقتراح اسم الزبون، وترقيم
  الفواتير من سلاسل الأمين. النسخة المنشورة tobacco-114 / v381.
- **معلّق على المالك (خطوة إلزامية):** تسجيل المهمة المجدولة للترقيم، وإلا لا
  يظهر رقم فاتورة إطلاقاً ويُمنع الحفظ والطباعة:
  `powershell -File "C:\Users\LOQ\Documents\OZK-TOBACCO\tobacco-web\tools\register-invoice-series-task.ps1"`
  (كمسؤول). ثم تجربة الهاتف: الطباعة، اقتراح الزبون، الرقم 202/601، كود الأمين
  `0000`، ثبات عمود اسم الصنف، آخر سعر للزبون، وتحذير ⛔ لأحد المتجاوزين الثمانية.
...
- ملف الأسعار (لم يُبدأ): 13 صنفاً سعرها تحت التكلفة و62 صنفاً سعرها أقدم من 30
  يوماً مع مخزون — القوائم في `reports/prices/below-cost-2026-07-25.csv` و
  `reports/prices/stale-prices-with-stock-2026-07-25.csv` (خارج Git). وكذلك 15
  كود صنف له سعران مختلفان في `approved_price_items` — لم يُفحص بعد.
- المسؤول: —

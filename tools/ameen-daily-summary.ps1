...
where
  en.Date >= convert(datetime, '$ReportDate', 120)
  and en.Date < dateadd(day, 1, convert(datetime, '$ReportDate', 120))
...
"@
  ...
  return Invoke-SqlRows -ConnectionString $ConnectionString -Query $query
}

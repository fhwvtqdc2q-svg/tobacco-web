(() => {
  const selector = "input[name='salePrice'], input[name='creditLimit'], input[name='lowThreshold'], input[data-inv-field='qty'], input[data-inv-field='price'], input[data-sales-num], input[data-po-field='qty'], input[data-po-field='price'], input[data-po-field='payment'], .journal-line-amount, .journal-ex-rate";
